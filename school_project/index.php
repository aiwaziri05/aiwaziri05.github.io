...
<section class="p-5 mt-5  align-items-center justify-content-center">
  <div class="form-header p-2 mb-4 text-center">
        ...
        <div class="log d-flex align-items-center justify-content-center p-2">
          <div>
          <a href="" role="button" class="btn btn-primary btn-sm mx-3">Admin</a>

          <a href="./STUDENT/login.php" role="button" class="btn btn-outline-primary btn-sm mx-3">Student</a>
          </div>
        </div>
      </div>
    ...
    <div class="my-4">
        <p class="fw-medium text-center">
            Already have an Account?
             <a href="./ADMIN/signup.php" class="nav-link d-inline-block text-primary">
                SignUp
            </a>
        </p>
    </div>
